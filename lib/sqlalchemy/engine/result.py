...
from ._result_cy import _NO_ROW
from ._result_cy import _R
from ._result_cy import _RowData
from ._result_cy import _UniqueFilterType
from ._result_cy import BaseResultInternal

if True:
    from ._result_cy import _NoRow
...
class Result(_WithKeys, ResultInternal[Row[Unpack[_Ts]]]):
    ...
    def fetchmany(
        ...
        return self._manyrow_getter(size)
